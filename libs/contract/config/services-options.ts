  ...
  chat: [
    {
      ...
      options: {
        urls: [
          `amqp://${process.env.RABBITMQ_USER || 'rabbit'}:${process.env.RABBITMQ_PASSWORD || 'rabbit_password'}@${process.env.RABBITMQ_HOST || 'localhost'}:${process.env.RABBITMQ_PORT || '5672'}`,
        ],
